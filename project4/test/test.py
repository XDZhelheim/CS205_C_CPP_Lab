...
if __name__ == "__main__":
    a1=np.loadtxt("../data/mat-A-2048.txt")
    b1=np.loadtxt("../data/mat-B-2048.txt")
    out1=np.loadtxt("../temp2048.txt")
    out2=np.matmul(a1, b1)
    out3=np.loadtxt("../../project3/test/out-C-2048.txt")
    print(rmse(out1, out2))
    print(rmse(out3, out2))
    exit(0)
